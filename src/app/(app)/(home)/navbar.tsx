...
const NavbarItem = ({
    ...
    return (
        <Button
            ...
            variant = "outline"
            className={cn(
                "bg-transparent hover:bg-transparent rounded-full hover:border-primary border-transparent px3.5 text-lg",
...
export const Navbar = () => {
  ...
  return (
    <nav className="h-20 flex items-center justify-between px-6 border-b font-medium bg-white">
      ...
      {/* Nav Links */}
      <div className="items-center gap-4 hidden lg:flex pr-2">
